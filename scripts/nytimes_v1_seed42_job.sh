#!/usr/bin/env bash
# One gpuq job: train NYTimes v1 (seed 42), sample it, and measure it against
# the cleaned real corpus.
#
#   gpuq submit --project wgan-synthetic --commit <sha> --branch nytimes-eda \
#     --lane gpu -- bash scripts/nytimes_v1_seed42_job.sh
#
