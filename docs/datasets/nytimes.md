...
| `v3` | `v2c` with the generator changed to `spherical` (`generator_type: spherical`, `tangent_hidden_dim` 512, radius band 0.2 to 1.5 from 0.95) | `configs/nytimes/v3.yaml`; box instrument `configs/nytimes/v3_seed42.yaml` | `runs/nytimes/v3_seed42` (box: `/workspace/nytimes-v3/v3_seed42`) | config written 2026-09-15 (`scripts/nytimes_v3_seed42_job.sh`); submitted 2026-09-15 as `wgan-synthetic-20260915T151526Z-1b3f8a` at commit `db454d8`, not yet trained. Why: `docs/ai/specs/2026-09-15-spherical-generator-design.md`, from the trunk-scale probes under `docs/results/nytimes-trunk-scale-probe/` |
